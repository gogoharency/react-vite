...
const identity2 = <T, Y>(arg1: T, arg2: Y):  void =>  {
...
interface keyT {
 ...
 type keyList = keyof keyT // "name" | "age" | "hender"


const user1 = {name: 'ddd', value: 1}

type user1Type = typeof user1  // { name: string, value: number }


 type keyList1 = "name" | "age" | "hender"

  // in只能在type中去定义，不能在interface中使用
 type keyTT = {
		[key in keyList1]: string
	}
